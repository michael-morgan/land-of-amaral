...
public class BloodLord extends Entity
{
	...
	private Image[] bloodlordFront, bloodlordBack, bloodlordLeft, bloodlordRight, hp;
	...
	/**
	 * BloodLord constructor
	 */
	public BloodLord(Screen screen)
	{
		this.screen = screen;

		init();
	} //end BloodLord constructor
	...
	private void initVariables()
	{
		...
		x = 0 + random.nextInt(383);
		y = 0 + random.nextInt(372);
		dx = 1D;
		dy = 1D;
		...
		bloodlordFront = new Image[2];
		bloodlordFront[0] = new ImageIcon("res/enemy/bloodlord/bloodlordfront1.png").getImage();
		bloodlordFront[1] = new ImageIcon("res/enemy/bloodlord/bloodlordfront2.png").getImage();
		bloodlordBack = new Image[2];
		bloodlordBack[0] = new ImageIcon("res/enemy/bloodlord/bloodlordback1.png").getImage();
		bloodlordBack[1] = new ImageIcon("res/enemy/bloodlord/bloodlordback2.png").getImage();
		bloodlordLeft = new Image[2];
		bloodlordLeft[0] = new ImageIcon("res/enemy/bloodlord/bloodlordleft1.png").getImage();
		bloodlordLeft[1] = new ImageIcon("res/enemy/bloodlord/bloodlordleft2.png").getImage();
		bloodlordRight = new Image[2];
		bloodlordRight[0] = new ImageIcon("res/enemy/bloodlord/bloodlordright1.png").getImage();
		bloodlordRight[1] = new ImageIcon("res/enemy/bloodlord/bloodlordright2.png").getImage();
	...
	public void render(Graphics g)
	{
		...
		if(moving)
		{
			if(left)
			{
				g.drawImage(bloodlordLeft[animation], x + screen.getMap().getX(), y + screen.getMap().getY(), null);
			}
			if(right)
			{
				g.drawImage(bloodlordRight[animation], x + screen.getMap().getX(), y + screen.getMap().getY(), null);
			}
			if(up)
			{
				g.drawImage(bloodlordBack[animation], x + screen.getMap().getX(), y + screen.getMap().getY(), null);
			}
			if(down)
			{
				g.drawImage(bloodlordFront[animation], x + screen.getMap().getX(), y + screen.getMap().getY(), null);
			}
		}
		else
		{
			if(left)
			{
				g.drawImage(bloodlordLeft[0], x + screen.getMap().getX(), y + screen.getMap().getY(), null);
			}
			if(right)
			{
				g.drawImage(bloodlordRight[0], x + screen.getMap().getX(), y + screen.getMap().getY(), null);
			}
			if(up)
			{
				g.drawImage(bloodlordBack[0], x + screen.getMap().getX(), y + screen.getMap().getY(), null);
			}
			if(down)
			{
				g.drawImage(bloodlordFront[0], x + screen.getMap().getX(), y + screen.getMap().getY(), null);
			}
		}
	...
	public void update()
	{
		...
		else if(aggro)
		{
			...
			if(x < screen.getPlayer().getX() - screen.getMap().getX() && x < 383)
			{
				moving = true;
				resetBloodlord();
				setRight();
			...
			else if(y < screen.getPlayer().getY() - screen.getMap().getY() + 32 && y < 372)
			{
				moving = true;
				resetBloodlord();
				setDown();
	...
	/**
	 * incrementBloodlordX method
	 */
	public void incrementBloodlordX()
	{
		x += dx;
	} //end of incrementBloodlordX method

	/**
	 * decrementBloodlordX method
	 */
	public void decrementBloodlordX()
	{
		x -= dx;
	} //end of decrementBloodlordX method

	/**
	 * incrementBloodlordY method
	 */
	public void incrementBloodlordY()
	{
		y += dy;
	} //end of incrementBloodlordY method

	/**
	 * decrementBloodlordY method
	 */
	public void decrementBloodlordY()
	{
		y -= dy;
	} //end of decrementBloodlordY method
	...
	/**
	 * resetBloodlord method
	 */
	public void resetBloodlord()
	{
		left = false;
		right = false;
		up = false;
		down = false;
	} //end of resetBloodlord method
